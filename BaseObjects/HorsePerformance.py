...
class HorsePerformance:
    def __init__(self, race_id: RaceID):
        ...
        self.lead_or_beaten[0]: int = None
        self.lead_or_beaten[330]: int = None
        self.lead_or_beaten[440]: int = None
        self.lead_or_beaten[660]: int = None
        self.lead_or_beaten[880]: int = None
        self.lead_or_beaten[990]: int = None
        self.lead_or_beaten[1100]: int = None
        self.lead_or_beaten[1210]: int = None
        self.lead_or_beaten[1320]: int = None
        self.lead_or_beaten[1430]: int = None
        self.lead_or_beaten[1540]: int = None
        self.lead_or_beaten[1610]: int = None
        self.lead_or_beaten[1650]: int = None
        self.lead_or_beaten[1760]: int = None
        self.lead_or_beaten[1830]: int = None
        self.lead_or_beaten[1870]: int = None
        self.lead_or_beaten[1980]: int = None
