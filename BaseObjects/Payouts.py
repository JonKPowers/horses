...
class Payouts:
    def __init__(self, race_id: RaceID, db_handler: DBHandler):
        ...
        self.program_num_to_horse_id: Dict[int, HorseID] = None

        # W/P/S payout lists:
        self.win_payouts: Dict[HorseID, float] = None
        self.place_payouts: Dict[HorseID, float] = None
        self.show_payouts: Dict[HorseID, float] = None
    ...
    def _get_payout_info(self):
        ...
        for horse in itm_horses:
            ...
            self.program_num_to_horse_id[horse[1]] = horse_id
