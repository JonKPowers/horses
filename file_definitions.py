file_1_columns = [      ##      Race file (1 record per race)
...
file_2_columns = [      ##      Start file (1 record per start)
'track_code',           ##      1       CHARACTER                       3
'date',                 ##      2                       YYYYMMDD        8
...
file_3_columns = [      ##      ITM payoff file
...
file_4_columns = [      ##      Exotic Payoff File (1 record for each payoff)
'track_code',           ##      1       CHARACTER                       3
'date',                 ##      2                       YYYYMMDD        8
'race_num',             ##      3       NUMERIC                         2
'day_evening_flag',     ##      4       CHARACTER                       1       D- Day Racing
...
file_5_columns = [      ##      FILE #5: BREEDING File (1 record per race winner)
...
file_6_columns = [      ##      FOOTNOTES File (usually contains multiple records per race)
"track_code",           ##      1       CHARACTER                       3
"date",                 ##      2                       YYYYMMDD        8
"race_num",             ##      3       NUMERIC                         2
"day_evening_flag",     ##      4       CHARACTER                       1       D- Day Racing
...
past_perf_columns = [   ## Up to date as of 4/28/2014
...
'life_turf_earnings',       ##      79      NUMERIC         99999999        8
...
'fast_dirt_wins_shows',             ##      1335    NUMERIC         99      2
'fast_dirt_earnings',               ##      1336    NUMERIC         9(9)    9
