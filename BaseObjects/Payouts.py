...
class Payouts:
    def __init__(self, race_id: RaceID, db_handler: DBHandler):
        ...
        self.exotic_names: Dict[str, str] = {
            ...
            'Pick Five': 'pick_five',
            'Pick Six': 'pick_six',
            'Pick 6 Jackpot': 'pick_six_jackpot',
            'Pick Seven': 'pick_seven',
            'Pick 7 Jackpot': 'pick_seven_jackpot',
            'Pick Nine': 'pick_nine',
            'Pick 9 Jackpot': 'pick_nine_jackpot',
            'Pick Ten': 'pick_ten',
            'Consolation Double': 'consolation_double',
            'Consolation Pick Three': 'consolation_pick_three',
            'Quinella': 'quinella',
            'Twin Trifecta': 'twin_trifecta',
            'Tri Super': 'tri_super',
            'Super High Five': 'super_high_five',
            'X-5 Super High Five': 'x_5_super_high_five',
            'Z-5 Super Hi-5': 'z_5_super_high_five',
            'Grand Slam': 'grand_slam',
            'Place Pick All': 'place_pick_all',
            'Win Four': 'win_four',
            '123 racing': 'one_two_three_racing',
            'Classix': 'classix',
            'Jockey Challenge': 'jockey_challenge',
            'Head To Head': 'head_to_head',
            'Future Wager': 'future_wager',
        }
