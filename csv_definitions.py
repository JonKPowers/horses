...
file_dtypes = {
    '1': {
        ...
        'allowed_age_two': 'INT',
        'allowed_age_three': 'INT',
        'allowed_age_four': 'INT',
        'allowed_age_five': 'INT',
        'allowed_age_older': 'INT',
        'allowed_fillies': 'INT',
        'allowed_mares': 'INT',
        'allowed_colts_geldings': 'INT',
        ...
        'full_condition_slug': 'VARCHAR(255)',
        'left_to_parse': 'VARCHAR(255)',
        'optional_claiming_price': 'INT',

        'claim_start_req_price': 'INT',
        'claim_start_req_time_limit': 'VARCHAR(255)',
        'claim_start_req_time_limit_months': 'INT',
        'number_limit': 'INT',
        'money_limit': 'INT',
        'time_limit': 'VARCHAR(255)',
        'time_limit_months': 'FLOAT',
        'excluded_races': 'VARCHAR(255)',
        'unrecognized_races': 'VARCHAR(255)',
        'CLAIMING': 'TINYINT(1)',
        'MAIDEN': 'TINYINT(1)',
        'OPTIONAL': 'TINYINT(1)',
        'RESTRICTED': 'TINYINT(1)',
        'RESTRICTED ALLOWANCE': 'TINYINT(1)',
        'STARTER': 'TINYINT(1)',
        'STATE SIRED': 'TINYINT(1)',
        'STATE SIRED STAKES': 'TINYINT(1)',
        'STATEBRED': 'TINYINT(1)',
        'STATEBRED ALLOWANCE': 'TINYINT(1)',
        'STATEBRED STAKES': 'TINYINT(1)',
        'TRIAL': 'TINYINT(1)',
        'WAIVER': 'TINYINT(1)',
        'WAIVER CLAIMING': 'TINYINT(1)',

        'excepted_1_claim_start_req_price': 'INT',
        'excepted_1_claim_start_req_time_limit': 'VARCHAR(255)',
        'excepted_1_claim_start_req_time_limit_months': 'INT',
        'excepted_1_number_limit': 'INT',
        'excepted_1_money_limit': 'INT',
        'excepted_1_time_limit': 'VARCHAR(255)',
        'excepted_1_time_limit_months': 'FLOAT',
        'excepted_1_excluded_races': 'VARCHAR(255)',
        'excepted_1_unrecognized_races': 'VARCHAR(255)',
        'excepted_1_CLAIMING': 'TINYINT(1)',
        'excepted_1_MAIDEN': 'TINYINT(1)',
        'excepted_1_OPTIONAL': 'TINYINT(1)',
        'excepted_1_RESTRICTED': 'TINYINT(1)',
        'excepted_1_RESTRICTED ALLOWANCE': 'TINYINT(1)',
        'excepted_1_STARTER': 'TINYINT(1)',
        'excepted_1_STATE SIRED': 'TINYINT(1)',
        'excepted_1_STATE SIRED STAKES': 'TINYINT(1)',
        'excepted_1_STATEBRED': 'TINYINT(1)',
        'excepted_1_STATEBRED ALLOWANCE': 'TINYINT(1)',
        'excepted_1_STATEBRED STAKES': 'TINYINT(1)',
        'excepted_1_TRIAL': 'TINYINT(1)',
        'excepted_1_WAIVER': 'TINYINT(1)',
        'excepted_1_WAIVER CLAIMING': 'TINYINT(1)',

        'excepted_2_claim_start_req_price': 'INT',
        'excepted_2_claim_start_req_time_limit': 'VARCHAR(255)',
        'excepted_2_claim_start_req_time_limit_months': 'INT',
        'excepted_2_number_limit': 'INT',
        'excepted_2_money_limit': 'INT',
        'excepted_2_time_limit': 'VARCHAR(255)',
        'excepted_2_time_limit_months': 'FLOAT',
        'excepted_2_excluded_races': 'VARCHAR(255)',
        'excepted_2_unrecognized_races': 'VARCHAR(255)',
        'excepted_2_CLAIMING': 'TINYINT(1)',
        'excepted_2_MAIDEN': 'TINYINT(1)',
        'excepted_2_OPTIONAL': 'TINYINT(1)',
        'excepted_2_RESTRICTED': 'TINYINT(1)',
        'excepted_2_RESTRICTED ALLOWANCE': 'TINYINT(1)',
        'excepted_2_STARTER': 'TINYINT(1)',
        'excepted_2_STATE SIRED': 'TINYINT(1)',
        'excepted_2_STATE SIRED STAKES': 'TINYINT(1)',
        'excepted_2_STATEBRED': 'TINYINT(1)',
        'excepted_2_STATEBRED ALLOWANCE': 'TINYINT(1)',
        'excepted_2_STATEBRED STAKES': 'TINYINT(1)',
        'excepted_2_TRIAL': 'TINYINT(1)',
        'excepted_2_WAIVER': 'TINYINT(1)',
        'excepted_2_WAIVER CLAIMING': 'TINYINT(1)',
    ...
    'DRF': {
        ...
        'past_age_sex_restrictions_10': 'VARCHAR(255)',
                                            ...
                                            ##                                              F - Fillies Only
                                            ##      E.g.: 'BON' - means a '3 year olds only,'  no sex restrictions
        'past_allowed_age_two_1': 'INT',
        'past_allowed_age_three_1': 'INT',
        'past_allowed_age_four_1': 'INT',
        'past_allowed_age_five_1': 'INT',
        'past_allowed_age_older_1': 'INT',
        'past_allowed_fillies_1': 'INT',
        'past_allowed_mares_1': 'INT',
        'past_allowed_colts_geldings_1': 'INT',
        ...
        'cond_race_class': 'VARCHAR(255)',
        'standard_weight': 'INT',
        'three_yo_weight': 'INT',
        'cond_rail_distance': 'INT',
        'weight_allowance_0_amt': 'INT',
        'weight_allowance_0_condition': 'VARCHAR(255)',
        'weight_allowance_1_amt': 'INT',
        'weight_allowance_1_condition': 'VARCHAR(255)',
        'weight_allowance_2_amt': 'INT',
        'weight_allowance_2_condition': 'VARCHAR(255)',
        'weight_allowance_3_amt': 'INT',
        'weight_allowance_3_condition': 'VARCHAR(255)',
        'cond_left_on_string': 'VARCHAR(255)',
